...
class Toastr
{
    ...
    {
        return '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/hanudevs/toastr@' . $version . '/dist/css/hanudev-toastr.min.css">';
    }
    ...
    {
        return '<script src="https://cdn.jsdelivr.net/gh/hanudevs/toastr@' . $version . '/dist/js/hanudev-toastr.min.js"></script>';
    }
