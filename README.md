# Hanudev Toastr for Laravel

Hanudev Toastr is a Laravel package that provides an easy way to display toast notifications in your Laravel applications.

![Hanudev Toastr](https://cdn.Hanudev.com/github/nRaAYW9TQI.jpg)
...
To get started with Hanudev Toastr, follow these steps:
...
```bash
composer require Hanudev/toastr
```
...
```bash
php artisan vendor:publish --tag=config --provider="Hanudev\Toastr\ToastrServiceProvider"
```
...
```bash
php artisan vendor:publish --tag=toastr-assets --provider="Hanudev\Toastr\ToastrServiceProvider"
```
...
<head>
    <!-- Include Toastr CSS -->
    <link rel="stylesheet" href="{{ asset('vendor/toastr/css/hanudev-toastr.min.css') }}">
</head>
<body>
    <!-- Your HTML content -->
    
    <!-- Include Toastr JavaScript -->
    <script src="{{ asset('vendor/toastr/js/hanudev-toastr.min.js') }}"></script>
    @toastrRender
</body>
</html>
```
...
return [
    ...
    'options' => [
        ...
        'closeButtonIcon' => 'hanudev-toast-close-icon',
        ...
        'positionClass' => 'hanudev-toast-top-right',
        ...
        'icons' => [
            'info' => 'hanudev-toast-info-icon',
            'warning' => 'hanudev-toast-warning-icon',
            'success' => 'hanudev-toast-success-icon',
            'error' => 'hanudev-toast-error-icon',
        ],
        ...
        'colorsClasses' => [
            'info' => 'hanudev-toast-info',
            'warning' => 'hanudev-toast-warning',
            'success' => 'hanudev-toast-success',
            'error' => 'hanudev-toast-error',
        ],
    ],
...
- Email: [support@hanudev.com](mailto:support@hanudev.com)
